...
export default function CorbuBeachMap() {
  const t = useTranslations('corbuMap');
    ...
    <section id="map" className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          */}
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2848.5!2d28.7!3d44.35!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40baf60!2sCorbu%20Beach!5e0!3m2!1sen!2sro!4v1700000000000!5m2!1sen!2sro"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
