...
export default function CorbuBeachPhotoSpots() {
  const t = useTranslations('corbuPhotoSpots');
  const messages = useMessages() as any;
  const spots = (messages?.corbuPhotoSpots?.spots || []) as Array<{ name: string; desc: string }>;
