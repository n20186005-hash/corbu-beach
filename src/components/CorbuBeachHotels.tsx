...
export default function CorbuBeachHotels() {
  const t = useTranslations('corbuHotels');
  const messages = useMessages() as any;
  const hotels = (messages?.corbuHotels?.hotels || []) as Array<{ name: string; desc: string; price: string }>;
