...
export default function CorbuBeachGallery() {
  const t = useTranslations('corbuGallery');
  const messages = useMessages() as any;
  const captions = (messages?.corbuGallery?.captions || []) as string[];
  
  const photos = [
    { src: '/gallery/corbu-beach-1.jpg', alt: captions[0] || 'Corbu Beach Aerial View' },
    { src: '/gallery/corbu-beach-2.jpg', alt: captions[1] || 'Pristine Beach' },
    { src: '/gallery/corbu-beach-3.jpg', alt: captions[2] || 'Clear Black Sea Waters' },
    { src: '/gallery/corbu-beach-4.jpg', alt: captions[3] || 'Sand Dunes' },
    ...
    { src: '/gallery/corbu-beach-8.jpg', alt: captions[7] || 'Wilderness' },
    { src: '/gallery/corbu-beach-9.jpg', alt: 'Corbu Beach' },
    { src: '/gallery/corbu-beach-10.jpg', alt: 'Coastal Scenery' },
    { src: '/gallery/corbu-beach-11.jpg', alt: 'Nature Reserve' },
    { src: '/gallery/corbu-beach-12.jpg', alt: 'Beach Landscape' },
  ];
