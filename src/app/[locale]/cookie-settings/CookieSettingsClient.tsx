        ...
        <div className="space-y-4 mb-8">
          ...
          <div>
            ...
            {t('analytics.analyticsDesc') && (
              <p className="text-xs mt-1 ml-2" style={{ color: 'var(--text-muted)' }}>{t('analytics.analyticsDesc')}</p>
            )}
          </div>
          <div>
            <CookieToggle
            ...
            />
            {t('preferences.prefDesc') && (
              <p className="text-xs mt-1 ml-2" style={{ color: 'var(--text-muted)' }}>{t('preferences.prefDesc')}</p>
            )}
          </div>
          <div>
            <CookieToggle
            ...
            />
            {t('marketing.marketingDesc') && (
              <p className="text-xs mt-1 ml-2" style={{ color: 'var(--text-muted)' }}>{t('marketing.marketingDesc')}</p>
            )}
          </div>
        </div>
