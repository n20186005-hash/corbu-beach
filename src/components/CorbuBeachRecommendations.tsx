...
export default function CorbuBeachRecommendations() {
  const t = useTranslations('corbuRecommendations');
  const messages = useMessages() as any;
  const attractions = (messages?.corbuRecommendations?.attractions || []) as Array<{ name: string; url: string }>;
  const tours = (messages?.corbuRecommendations?.tours || []) as Array<{ name: string; url: string }>;
